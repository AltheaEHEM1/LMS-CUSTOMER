...
<div class="bg-[#E4ECFF] min-h-screen p-8 mb-0">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
        <!-- Team Member Card 1 -->
        <div class="bg-gray-100 rounded-lg shadow-md p-6 flex flex-col items-center w-[250px]">
            <div class="bg-gray-100 w-[250px] h-[200px] rounded-t-lg p-4"> <!-- Same color background and padding -->
